...
public class CameraCheckActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText weightView =(EditText)findViewById(R.id.updateWeightv1);
        EditText muscleView =(EditText)findViewById(R.id.muscle);
        EditText fatView =(EditText)findViewById(R.id.check_fat);
...
//                EditText fat = (EditText) findViewById(R.id.check_fat);
                // 체중 가져오기
                getWeight = weightView.getText().toString();
                // 골격근량 가져오기
                getMuscle = muscleView.getText().toString();
                // 체지방량 가져오기
                getFat = fatView.getText().toString();
            }
        });
